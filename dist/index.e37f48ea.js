...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config.js":"k5Hzs","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
const KEY = "1d7f4585-b201-4ef4-8f66-3c909a108754";
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (this._data.page === 1 && numPages > 1) return this._generateMarkupNextButton();
        // Last Page
        if (this._data.page === numPages && numPages > 1) return this._generateMarkupPrevButton();
        // Other Page
        if (this._data.page < numPages) return this._generateMarkupPrevButton() + this._generateMarkupNextButton();
